...
import certifi # Import ssl certificate
ca = certifi.where() # Access ssl from anywhere

# Connect to MongoDB
client = MongoClient("mongodb+srv://mrrobot:t00r@cluster0.4fo4qnv.mongodb.net/", tlsCAFile=ca)
...
# Mapping for tea type and cup size
tea_type_mapping = {1: "Latte", 2: "Black Coffee", 3: "Tea"}
cup_size_mapping = {1: "Small", 2: "Medium", 3: "Large"}
...
def save_to_mongodb(tea_type, sugar_level, cup_size):
    order_data = {
        ...
        "cup_size": cup_size_mapping[cup_size]
    }
